...
class UploadFotoPage extends StatefulWidget {
  ...
  const UploadFotoPage({Key? key, required this.userId}) : super(key: key);
  @override
...
class _UploadFotoPageState extends State<UploadFotoPage> {
  ...
  Future<void> _uploadImage() async {
    if (_pickedXFile == null || _webImage == null) {
    ...
    try {
      var url = Uri.parse("http://localhost/flutter_api/user/upload_image.php");
      ...
      if (response.statusCode == 200 && data['status'] == 'success') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(data['message'] ?? "Gagal upload gambar"),
